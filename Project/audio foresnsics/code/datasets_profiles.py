...
class CelebDF(selfdataset):
    def __init__(self, folder_path="/data2/dl/DATASETS/FakeImgDatasets/Celeb-DF"):
...
#'generated_audio/ljspeech_parallel_wavegan' , 'generated_audio/ljspeech_multi_band_melgan/','generated_audio/jsut_parallel_wavegan','generated_audio/ljspeech_waveglow' ,'generated_audio/ljspeech_melgan_large','generated_audio/ljspeech_melgan','generated_audio/ljspeech_hifiGAN','generated_audio/ljspeech_full_band_melgan','generated_audio/jsut_multi_band_melgan'
# "/data2/dl/DATASETS/audio foresnsics/images/LJSpeech-1.1/"
class DFFD(selfdataset):
    def __init__(self, folder_path="/data2/dl/DATASETS/audio foresnsics/images/"):#"/data2/dl/DATASETS/FakeImgDatasets/"
        super(selfdataset, self).__init__()
        self.folder_path = folder_path
        self.R_dir = ["LJSpeech-1.1/wavs"]#, "celeba_2w"] ,"ffhq","original_sequences/youtube/c23"#,
        self.F_dir = [ "generated_audio/mixed_gen"]#"generated_audio/mixed_gen"#,"generated_audio/ljspeech_multi_band_melgan","generated_audio/ljspeech_parallel_wavegan"]#ljspeech_multi_band_melgan
#["generated_audio/jsut_multi_band_melgan",,"generated_audio/ljspeech_full_band_melgan","generated_audio/ljspeech_hifiGAN","generated_audio/ljspeech_melgan","generated_audio/ljspeech_melgan_large","generated_audio/ljspeech_multi_band_melgan","generated_audio/ljspeech_parallel_wavegan","generated_audio/ljspeech_waveglow"]#[ "manipulated_sequences/Deepfakes/c23", "manipulated_sequences/FaceSwap/c23", "manipulated_sequences/Face2Face/c23","stylegan_celeba", "stylegan_ffhq", "faceapp", "stargan", "pggan_v1", "pggan_v2"]
...
class DFFD_erased(selfdataset):
    def __init__(self, folder_path="/data2/dl/DATASETS/FakeImgDatasets/"):
        super(selfdataset, self).__init__()
        self.folder_path = folder_path
        self.R_dir = ["youtube", "ffhq", "celeba_2w"]
        self.F_dir = [ "manipulated_sequences/Deepfakes", "manipulated_sequences/FaceSwap", "manipulated_sequences/Face2Face","stylegan_celeba", "stylegan_ffhq", "faceapp", "stargan", "pggan_v1", "pggan_v2"]
        self.trainpath = lambda path, file: os.path.join(self.folder_path, file, "train")
        self.validpath = lambda path, file: os.path.join(self.folder_path, file, "validation")
        self.testpath = lambda path, file: os.path.join(self.folder_path, file, "test")
