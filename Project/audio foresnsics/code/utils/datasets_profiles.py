...
class DFFD(selfdataset):
    def __init__(self, folder_path="/data2/dl/DATASETS/audio foresnsics/images/"):#"/data2/dl/DATASETS/FakeImgDatasets/"
        super(selfdataset, self).__init__()
        self.folder_path = folder_path
        self.R_dir = ["LJSpeech-1.1"]#, "celeba_2w"] ,"ffhq","original_sequences/youtube/c23"#,
        self.F_dir = ["generated_audio/jsut_multi_band_melgan","generated_audio/jsut_parallel_wavegan","generated_audio/ljspeech_full_band_melgan","generated_audio/ljspeech_hifiGAN","generated_audio/ljspeech_melgan","generated_audio/ljspeech_melgan_large","generated_audio/ljspeech_multi_band_melgan","generated_audio/ljspeech_parallel_wavegan","generated_audio/ljspeech_waveglow"]#[ "manipulated_sequences/Deepfakes/c23", "manipulated_sequences/FaceSwap/c23", "manipulated_sequences/Face2Face/c23","stylegan_celeba", "stylegan_ffhq", "faceapp", "stargan", "pggan_v1", "pggan_v2"]
