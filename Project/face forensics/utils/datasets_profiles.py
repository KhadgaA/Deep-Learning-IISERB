...
class CelebDF(selfdataset):
    def __init__(self, folder_path="./FakeImgDatasets/Celeb-DF"):
...
class DFFD(selfdataset):
    def __init__(self, folder_path="./FakeImgDatasets/"):
        super(selfdataset, self).__init__()
        self.folder_path = folder_path
        self.R_dir = ["ffhq"]#, "celeba_2w"] #"youtube",
        self.F_dir = [ "manipulated_sequences/Deepfakes", "manipulated_sequences/FaceSwap", "manipulated_sequences/Face2Face"]#["stylegan_celeba", "stylegan_ffhq", "faceapp", "stargan", "pggan_v1", "pggan_v2", "Deepfakes", "FaceSwap", "Face2Face"]
...
class DFFD_erased(selfdataset):
    def __init__(self, folder_path="./FakeImgDatasets/"):
        ...
        self.F_dir = ["stylegan_celeba", "stylegan_ffhq", "faceapp", "stargan", "pggan_v1", "pggan_v2", "manipulated_sequences/Deepfakes", "manipulated_sequences/FaceSwap", "manipulated_sequences/Face2Face"]
        self.trainpath = lambda path, file: os.path.join(self.folder_path, file, "train")
        self.validpath = lambda path, file: os.path.join(self.folder_path, file, "validation")
        self.testpath = lambda path, file: os.path.join(self.folder_path, file, "test")
